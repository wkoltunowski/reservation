...
public class DefineScheduleService {
    ...
    private DateInterval regenerationInterval() {
        return fromTo(LocalDate.of(2018, 1, 1).atTime(0, 0), LocalDate.of(2019, 1, 1).atTime(0, 0));
    }
    ...
    private List<FreeScheduleSlot> regenerate(Schedule schedule) {
        return schedule.generateSlots(regenerationInterval());
    }

    public void updateSchedule(Schedule schedule) {
        checkNotNull(schedule.id(), "Cannot update new schedule!");
